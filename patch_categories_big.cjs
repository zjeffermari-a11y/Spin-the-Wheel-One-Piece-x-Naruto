...
const ninjutsuOptions = [
    ...
    { name: 'Flying Thunder God (Hiraishin)', rarity: 'E', val: 92, tag: 'hax' },
    { name: 'Reanimation Jutsu (Edo Tensei)', rarity: 'E', val: 95, tag: 'hax' },
    { name: 'Reaper Death Seal', rarity: 'E', val: 90 },
    { name: 'Tengai Shinsei (Shattered Heaven)', rarity: 'L', val: 98 },
...
const kekkeiGenkaiOptions = [
    { name: 'None', rarity: 'C', val: 0 },
    { name: 'Ice Release (Haku)', rarity: 'U', val: 60 },
    ...
    { name: 'Wood Release (Mokuton)', rarity: 'L', val: 98 },
    { name: 'Rinne-Sharingan', rarity: 'M', val: 100, tag: 'hax' }
];

const kekkeiTotaOptions = [
    { name: 'None', rarity: 'C', val: 0 },
    { name: 'Particle Style: Atomic Dismantling', rarity: 'L', val: 95, tag: 'hax' }
];
...
const senjutsuOptions = [
    ...
    { name: 'Wood Sage Mode (Hashirama)', rarity: 'L', val: 96 },
