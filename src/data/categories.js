export const devilFruitDB = [
    ...
    { name: "Iba Iba", type: "paramecia", rarity: "E", val: 88, tag: "thorn manifestation and manipulation" },
    ...
    { name: "Ryu Ryu: Nidhogg", type: "mythical", rarity: "M", val: 100, tag: "city-dwarfing black dragon" },
...
export const CATEGORIES = [
    ...
    { id: 'weapon', name: 'Weapon', desc: 'Primary armament', options: [{ name: 'Bare Fists', rarity: 'C', val: 0 }, { name: 'Kunai/Shuriken', rarity: 'C', val: 30 }, { name: 'Standard Sword', rarity: 'U', val: 60, tag: 'sword' }, { name: 'Clima-Tact', rarity: 'U', val: 65, desc: 'Weather-manipulating staff' }, { name: 'Kuro Kabuto (Usopp)', rarity: 'R', val: 80, tag: 'sniper', desc: 'A giant living slingshot that fires carnivorous plant projectiles' }, { name: 'War Bow of Ruin (Kidōmaru)', rarity: 'R', val: 82, tag: 'sniper', desc: 'A golden bow formed from spider resin firing highly destructive drill arrows' }, { name: 'Shusui', rarity: 'R', val: 80, tag: 'sword' }, { name: 'Kubikiribōchō', rarity: 'R', val: 75, tag: 'sword', desc: 'Executioner\'s Blade that regenerates from blood' }, { name: 'Kusanagi', rarity: 'R', val: 82, tag: 'sword' }, { name: 'Senriku (Van Augur\'s Rifle)', rarity: 'E', val: 92, tag: 'sniper', desc: 'An extra-long-barreled sniper rifle capable of impossible long-range precision' }, { name: 'Yasopp\'s Flintlock Rifle', rarity: 'E', val: 94, tag: 'sniper' }, { name: 'Enma', rarity: 'E', val: 92, tag: 'sword', desc: 'Cursed sword that forcefully drains Haki' }, { name: 'Samehada', rarity: 'E', val: 90, tag: 'sword', desc: 'Sentient shark-skin greatsword that absorbs chakra' }, { name: 'Gunbai', rarity: 'E', val: 88, desc: 'Massive war fan that absorbs and reflects jutsu' }, { name: 'Supreme Grade (Yoru)', rarity: 'L', val: 100, tag: 'sword', desc: 'A massive cross-shaped Black Blade greatsword' }, { name: 'Cerberus (Shamrock)', rarity: 'L', val: 100, tag: 'sword', desc: 'A Devil Fruit-empowered sword that transforms into a mythical three-headed beast with blades in each mouth' }, { name: 'Murakumogiri (Whitebeard)', rarity: 'L', val: 100, desc: 'A Supreme Grade massive naginata polearm' }, { name: 'Truth-Seeking Orbs', rarity: 'L', val: 100, tag: 'hax (erases matter/ninjutsu)' }] },
