import { PROGRESSION_CATEGORIES } from './progression.js';
...
export const CATEGORIES = [
    ...
    { id: 'vessel', name: 'Physical Vessel', desc: 'Whose base physical body do you possess?', options: [
        { name: 'None', rarity: 'C' },
        { name: 'Joyboy', rarity: 'M' }, { name: 'Imu', rarity: 'M' },
        { name: 'Guernica', rarity: 'E' }, { name: 'Kaku', rarity: 'E' },
        { name: 'Rob Lucci', rarity: 'L' }, { name: 'Monkey D. Dragon', rarity: 'L' },
        { name: 'Kaido', rarity: 'L' }, { name: 'Charlotte Linlin', rarity: 'L' },
        { name: 'Crocodile', rarity: 'E' }, { name: 'Benn Beckman', rarity: 'L' },
        { name: 'Usopp', rarity: 'R' }, { name: 'Yasopp', rarity: 'E' },
        { name: 'King Harald', rarity: 'L' }, { name: 'Prince Loki', rarity: 'L' },
        { name: 'Figarland Shamrock', rarity: 'L' }, { name: 'Manmayer Gunko', rarity: 'E' },
        { name: 'Shepherd Sommers', rarity: 'E' }, { name: 'Rimoshifu Killingham', rarity: 'L' },
        { name: 'Mu', rarity: 'L' }, { name: 'Kaguya Otsutsuki', rarity: 'M' },
        { name: 'Hagoromo Otsutsuki', rarity: 'M' }, { name: 'Isshiki Otsutsuki', rarity: 'M' },
        { name: 'Momoshiki Otsutsuki', rarity: 'M' }, { name: 'Eida', rarity: 'M' },
        { name: 'Boruto Uzumaki', rarity: 'L' }, { name: 'Mitsuki', rarity: 'E' },
        { name: 'Sarada Uchiha', rarity: 'E' }, { name: 'Shibai Otsutsuki', rarity: 'M' },
        { name: 'Jura', rarity: 'M' }, { name: 'Daemon', rarity: 'M' }, { name: 'Code', rarity: 'L' }
    ] },
    ...
    { id: 'dur', name: 'Durability Benchmark', desc: 'Resistance to physical damage', options: durabilityTiers },
    ...
    { id: 'df', name: 'Devil Fruit', desc: 'Your specific fruit power', options: [
        ...
        { name: "Uo Uo: Seiryu", type: "mythical_zoan", rarity: "M", val: 100, tag: "dragon" },
        { name: "Hito Hito: Nika", type: "mythical_zoan", rarity: "M", val: 105, tag: "hax toon" },
        { name: "Ryu Ryu: Nidhogg", type: "mythical_zoan", rarity: "M", val: 102, tag: "lightning dragon" },
        { name: "Ryu Ryu: Kirin", type: "mythical_zoan", rarity: "M", val: 99, tag: "dreams sleep" },
        { name: "Inu Inu: Cerberus", type: "mythical_zoan", rarity: "L", val: 95, tag: "three heads" },
        { name: "Aro Aro", type: "paramecia", rarity: "E", val: 85, tag: "arrows" },
        { name: "Iba Iba", type: "paramecia", rarity: "E", val: 82, tag: "thorns emotion" }
    ...
    { id: 'summon', name: 'Summoning', desc: 'Animal contract or ally', options: [{ name: 'None', rarity: 'C', val: 0 }, { name: 'Dogs', rarity: 'U', val: 60 }, { name: 'Hawks', rarity: 'U', val: 65 }, { name: 'Toads', rarity: 'R', val: 80 }, { name: 'Snakes', rarity: 'R', val: 80 }, { name: 'Slugs', rarity: 'R', val: 75 }, { name: 'Baku', rarity: 'E', val: 88 }, { name: 'Monkey King Enma', rarity: 'M', val: 100 }, { name: 'Gedo Statue', rarity: 'L', val: 100 }, { name: 'Sea Kings', rarity: 'L', val: 100 }, { name: 'Crows', rarity: 'U', val: 65 }, { name: 'Spiders', rarity: 'U', val: 60 }, { name: 'Salamander (Ibuse)', rarity: 'R', val: 80 }, { name: 'Kamatari (Weasel)', rarity: 'U', val: 65 }] },
